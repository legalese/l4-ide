...
2026-08-05 after Rule 501(a)'s "one year" became a calendar anniversary, and again
...
> count permitted and both engines now refuse. A second decomposition on
> 2026-08-09 — Rule 501(a)(4), one ~300-character boolean becoming six fields
> under a decision of their own — added one more of each, 69 → **70** and
> 21 → **22**, the new case being the ESCHEAT case: a transfer in connection
> with the purchaser's death to a transferee who is nobody in particular.
