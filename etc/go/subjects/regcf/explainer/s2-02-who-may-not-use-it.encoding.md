...
[issuer is eligible](src:jl4/examples/canon/us/regcf/regcf.l4#L332 "verbatim")
holds exactly when the issuer is not
[excluded by Rule 100(b)](src:jl4/examples/canon/us/regcf/regcf.l4#L333 "verbatim").
That one `NOT`
...
yes-or-no field —
[`subject to a disqualification as specified in section 227.503(a)`](src:jl4/examples/canon/us/regcf/regcf.l4#L270-L277 "verbatim")
