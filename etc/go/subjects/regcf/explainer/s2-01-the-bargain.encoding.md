...
[`the transaction qualifies for the section 4(a)(6) exemption`](src:jl4/examples/legal/regcf/regcf.l4#L880 "verbatim")
...
> [`the intermediary complies with section 4A(a) of the Securities Act and the related requirements in this part` IS A BOOLEAN](src:jl4/examples/legal/regcf/regcf.l4#L559 "verbatim")
