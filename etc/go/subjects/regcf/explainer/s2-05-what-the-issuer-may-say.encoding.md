...
that
[`SHANT ... WITHIN n` SUNSETS at n](src:jl4/examples/canon/us/regcf/regcf.l4#L644 "verbatim"),
so the borrowed deadline made the prohibition expire and
[an issuer advertising on day 400](src:jl4/examples/canon/us/regcf/regcf.l4#L645 "verbatim")
