...
> [A drafter who cared could remove the question with four words; a reader who cares must litigate it.](src:jl4/examples/legal/regcf/regcf.l4#L796-L798 "verbatim")
...
[`add years` (transfer's `date the securities were issued`)](src:jl4/examples/legal/regcf/regcf.l4#L790-L791 "verbatim"),
which the corpus notes is
[366 across a 29 February, 365 otherwise](src:jl4/examples/legal/regcf/regcf.l4#L772-L773 "verbatim").
...
[`add years` CLAMPS: the first anniversary of a 29 February issuance is 28 February](src:jl4/examples/legal/regcf/regcf.l4#L775-L776 "verbatim").
...
[This is a genuine fork; the UNIT question below was not](src:jl4/examples/legal/regcf/regcf.l4#L798-L799 "verbatim").
...
[a family or trust transferee, or a death-or-divorce circumstance](src:jl4/examples/legal/regcf/regcf.l4#L835 "verbatim"),
