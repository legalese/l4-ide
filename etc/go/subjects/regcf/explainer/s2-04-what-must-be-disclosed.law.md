The issuer files a Form C before it may sell anything, and Rule 201 lists what
must be in it: the business, the officers and significant shareholders, the use
of proceeds, the target amount, the deadline, the risks, related-party
...
Rule 201(t) also says that where higher-assurance statements are already
available, the issuer must supply those instead of the tier's minimum.
