...
[$5,000,000](src:jl4/examples/canon/us/regcf/regcf.l4#L151). Only prior sales made
...
at time of writing ({{as_of}}) [$124,000](src:jl4/examples/canon/us/regcf/regcf.l4#L163):

- **If either annual income or net worth is below the cut point**, the cap is the
  greater of [$2,500](src:jl4/examples/canon/us/regcf/regcf.l4#L172) and five per
...
- **If both are at or above the cut point**, the cap is ten per cent of the
  ...
  [$124,000](src:jl4/examples/canon/us/regcf/regcf.l4#L182).
...
[Are you an accredited investor, as Rule 501 of Regulation D defines that term?](src:jl4/examples/canon/us/regcf/regcf-wizard.l4#L123 "verbatim"),
which is where the definition lives. The carve-out itself is dated: the corpus
records that
[an accredited purchaser is subject to no Reg CF investment limit at all. Added 2021-03-15 by Release 33-10884](src:jl4/examples/canon/us/regcf/regcf.l4#L446-L448 "verbatim"),
...
income of [$60,000](src:jl4/examples/canon/us/regcf/regcf.l4#L1043) and net worth of
[$200,000](src:jl4/examples/canon/us/regcf/regcf.l4#L1043) falls in the first limb —
income is below the cut point — so the cap is five per cent of the _greater_
figure: [$10,000](src:jl4/examples/canon/us/regcf/regcf.l4#L1043).
...
[$3,000](src:jl4/examples/canon/us/regcf/regcf.l4#L1402).
