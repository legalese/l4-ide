...
income of [$60,000](src:jl4/examples/legal/regcf/regcf.l4#L1034) and net worth of
[$200,000](src:jl4/examples/legal/regcf/regcf.l4#L1034) falls in the first limb —
income is below the cut point — so the cap is five per cent of the _greater_
figure: [$10,000](src:jl4/examples/legal/regcf/regcf.l4#L1034).
...
[$3,000](src:jl4/examples/legal/regcf/regcf.l4#L1393).
