...
or divorce. It is worth reading in the original, and the ladder figure for this
decision in the **Pictures** section prints it whole, because that sentence _is_
the leaf: the encoding did not summarise it into a shorter field name, so the
diagram is as wide as the regulation is long.
