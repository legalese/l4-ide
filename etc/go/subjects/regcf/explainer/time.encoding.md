...
[the answer IS the cap — which also moved on 2022-09-20, in the same release, by the same instruction](src:jl4/examples/legal/regcf/regcf.l4#L1254-L1255 "verbatim").
Under a partially dated module the assertion at
[$107,000](src:jl4/examples/legal/regcf/regcf.l4#L1262) silently returns the
