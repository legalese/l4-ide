...
_**Census refreshed 2026-08-28** against `origin/unstable` and the merged-PR list. All three
bridges that were "in simultaneous flight" the day this was written — Blawx, Catala, DocAssemble —
have since shipped, and their rows said otherwise for over a week: the sentence above was written
but not obeyed. Rows updated in §2.2, §2.3 and §2.4._
...
| ----------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **execution**     | run the law              | OpenFisca, Catala, MLIR/WASM, Axiom Foundation's RuleSpec (researched 2026-09-09), Belastingdienst's RegelSpraak/ALEF (researched 2026-09-24) |
| **interchange**   | hand the law to a system | DMN, BPMN, JSON schema, Rulemapping's RUML (researched 2026-09-09, unpublished)                                                               |
| **interaction**   | ask the citizen          | DocAssemble, Blawx (front half), web wizards, DataLex/yscript (researched 2026-09-08)                                                         |
...
| **documentation** | show the law             | Markdown, NLG/TNR round-trip, Akoma Ntoso / AKN4EU (LEOS, researched 2026-09-24), ladder diagrams, literate weave, state-graph                |
...
**PROPOSED** (family spec exists, no code), **FUTURE** (named, no spec). Rows were written
2026-08-16; the execution, interaction and reasoning rows were re-verified and corrected
2026-08-28, and each now carries its own dates. Rows not touched that day still speak as of
2026-08-16 — check the pointer before relying on one.
...
| Catala                               | **SHIPPED** — spec PR #260 merged 2026-08-16 (R1–R11 ANSWERED; R4 REVERSED to Mode-B-primary, `219281c2`); implementation merged as #266 (2026-08-18) and relanded as #296 ("reland the stranded Catala backend", 2026-08-25): `L4.Catala.{IR,Lower,Emit,Equivalence}` + `l4 catala`, validated vs real catala 1.2.1 (typecheck+proof ×8, `clerk test` 64/64, `jl4-test` 2568/0) **[E]**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | merged PRs #260, #266, #296; `jl4-core/src/L4/Catala/`; `l4 catala`                                      |
| MLIR / WASM                          | **SHIPPED** in-tree (parity ledger) **[E]**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `jl4-mlir/`                                                                                              |
| TypeScript / JS                      | **FUTURE** — named 2026-09-07, no spec. Driver is deployment model, not language coverage: partners want on-prem, at-scale evaluation via a vendored **library** rather than a call to `jl4-service`. Eight open questions (numbers, layers, strictness, trace, idiom, types, CLI name, distribution) **[E 2026-09-07]**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `specs/roadmap/general-purpose-language-backends.md`                                                     |
| Go                                   | **FUTURE** — named 2026-09-07, no spec. Same driver; sequenced second because `DECLARE … IS ONE OF` has no Go sum type (Q6), while `math/big.Rat` gives it exact rationals for free (Q1) **[E 2026-09-07]**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `specs/roadmap/general-purpose-language-backends.md`                                                     |
| RuleSpec (Axiom Foundation)          | **FUTURE** — researched 2026-09-09, extended 2026-09-10; verdict: the closest structural match to L4's own design values found in this programme so far — cited, time-aware (`versions[]`/`effective_from` matches L4's own `EVAL … UNDER RULES EFFECTIVE AT` shape), a small boolean/arithmetic YAML expression language, compiled to Rust/WASM by a real, actively-maintained multi-jurisdiction corpus (2,600+ commits on `rulespec-us` alone). Not to be confused with PolicyEngine, which Axiom uses as a validation oracle and which is not itself a new target (`policyengine-core` is "Forked from OpenFisca-Core" **[E]**, so the existing shipped OpenFisca bridge is the relevant starting point, unverified for drift from current upstream). A **bidirectional** differential-exchange idea (mutual sanity-checking against overlapping statutes, prompted by an Axiom-side session) is backlogged separately in `specs/roadmap/future-features.md` | `specs/research/AXIOM-RULESPEC-POLICYENGINE-RESEARCH.md`                                                 |
...
The two FUTURE rows are the family's first entries distinguished by **deployment model** rather
than by which slice of L4 they consume, which is why they may not belong in this family at all —
see `specs/roadmap/general-purpose-language-backends.md` §6, which raises the taxonomy question
here rather than re-ruling P2 itself. Note
also that for JVM consumers the same need may already be met by `--to=dmn` plus an embedded KIE or
Camunda engine, the arrangement we already run as a harness (`etc/kie/`, `etc/kie-dmn-check/`,
`etc/camunda-dmn-check/`) **[E 2026-09-07]** — so Java is deliberately **not** listed above.
...
| RUML (Rulemapping) | **FUTURE, unpublished** — researched 2026-09-09; Rulemapping Group's own site states RUML "will be published," present tense, not yet: no schema, no example file, no GitHub org found anywhere under the Rulemapping name **[E]**. Revisit once it actually ships rather than building against the announcement | `specs/research/RULEMAPPING-RUML-RESEARCH.md`                                                                                          |
...
| target          | state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | owning artifact                                                                                            |
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| DocAssemble     | **COMPLETE for the specified scope: three milestones shipped, one declined on measurement** — M1 merged 2026-08-16 (#264 spec + #265, first bridge through the seam), then M2 (#267, 2026-08-18) and M4 (#268, 2026-08-19). Gates green at merge, re-run after `unstable` was merged in: `l4-cli-test` **317/0** (83 pending), `jl4-test` **2585/0**, corpus-goldens guard 355 files, headless harness vs `docassemble.base` 1.10.7 — counts supplied 2026-08-28 by the session that owns this bridge; the 272/0 and 2568/0 that stood here until then were the pre-rebase draft counts, carried forward unchecked while the rest of the cell was rewritten. M3 is **DECLINED on its own evidence, not deferred** (#269, merged 2026-08-20): measured over 589 decisions, adaptive info-gain ordering beats declaration order by 3.38% of one question, and a compile-time operand sort captures 100.00% of that (0/138 decisions favour the planner) — most L4 legal decisions are flat AND/OR chains (60/75 at the 2 − 2^−(n−1) closed form). Harness at `jl4/measure/`, re-runnable **[E]** | merged PRs #264, #265, #267, #268, #269; `jl4-core/src/L4/Docassemble/`; `l4 docassemble`                  |
| Blawx           | **SHIPPED, both directions** — spec PR #261 merged 2026-08-16; R1–R14 ANSWERED by Meng, recorded by PR #270 (merged 2026-08-18, which also opened the `DATE-LIBRARY-SPEC.md` ledger). Per R2 the middle-end landed first (#272), then export (#273), the Blockly XML + re-save fixpoint (#277), the P4 showcase ladder (#278), import — `Parse`/`Lift`, `l4 blawx --import` (#279) — and the documentation (#280). Per-phase evidence is inline in §10 of the owning spec. Per R10 generator-quirk fixes go to the `legalese/blawx` fork: five filed (#1–#5, 2026-08-20), none upstreamed to Lexpedite yet **[E]**                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | merged PRs #261, #270, #272, #273, #277, #278, #279, #280; `jl4-core/src/L4/Blawx/`; `l4 blawx [--import]` |
| web wizards     | **SHIPPED** (Housing Act, Reg CF; question-ordering PR #94 v1, #110 v2 priors)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | in-tree                                                                                                    |
| DataLex/yscript | **FUTURE** — researched 2026-09-08; verdict: a real, active, AGPL-licensed AustLII "Rules as Code" platform whose `Why?`/`How?`/verbose-trace/Report explanation apparatus and `ylegis` "legislation is code" preprocessor are the strongest overlaps with this project's own isomorphism and audit-trail goals, but whose executable fragment is propositional-only — no records, no regulative layer, no confirmed numeric/date discipline, narrower than any backend in this census. Not a Prolog-family member despite the initial hypothesis: no LP substrate underneath the interpreter, no multiplicity/burden/override construct **[E]**                                                                                                                                                                                                                                                                                                                                                                                                                                               | `specs/research/DATALEX-YSCRIPT-RESEARCH.md`                                                               |
...
emitters cannot be ported because its IR was already relational **[E]**. Blawx (PR #261)
positions itself as a _fifth consumer_ of `L4.Relational` rather than a fifth lowering, with one
recorded data-representation divergence (seam S2). The regulative layer is explicitly deferred by
#258 §5.6 **[E]**. Update 2026-08-28: the middle-end **landed** — driven by the Blawx session per
Blawx R2, merged as #272 on 2026-08-18 — so the four LP legs' R0 dependency is satisfied, and
Blawx did consume it as a fifth consumer rather than growing a lowering of its own.
...
| NLG / TNR round-trip            | **DESIGN** — the spec is on `unstable`, RULED 2026-09-02 (§10): generation is `l4 render` (text / html / akn), which is SHIPPED; the round trip is not built. Corrected 2026-09-24: this row said **BRANCH** (`nlg-roundtrip`), which the spec itself no longer supports **[E]**                                                                                                                                                                                                                                                                                                 | `specs/todo/NLG-TNR-ROUNDTRIP-SPEC.md`; `jl4-core/src/L4/Export/Render.hs`                                    |
| Akoma Ntoso 3.0 / AKN4EU (LEOS) | **SHIPPED, NOT SCHEMA-VALID** (generic AKN via `l4 render --format akn`) + **FUTURE** (AKN4EU for LEOS) — researched 2026-09-24; 0/343 corpus renders valid vs the OASIS XSD, 310/343 after adding `FRBRcountry` + `FRBRlanguage` (the other 33: empty `<body>`), measured on `unstable` @ `7df7a3ca` (the build-90 binary gave 0/169 and 153/169) **[E]**; eIds are gensyms that shift and alias on insertion **[E]**; LEOS accepts only its own `bill`/`doc` profile with `xml:id` + `leos:` metadata, via `.leg` upload or LEOS Light `import-document` with callback **[E]** | `jl4-core/src/L4/Export/Render.hs` (`renderAkn`); `l4 render --format akn`; `specs/research/LEOS-RESEARCH.md` |
