...
| target      | state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | owning artifact                                           |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| DocAssemble | **FEATURE-COMPLETE for specified scope** — M1 merged (#264+#265, first bridge through the seam). Open drafts, all gates green (build, `l4-cli-test` 272/0, `jl4-test` 2568/0, headless harness vs docassemble.base 1.10.7), stacked merge order **#267 (M2) → #268 (M4) → #269 (M3 decision)**. M3 is **DECLINED on its own evidence, not deferred**: measured over 589 decisions, adaptive info-gain ordering beats declaration order by 3.38% of one question, and a compile-time operand sort captures 100.00% of that (0/138 decisions favour the planner) — most L4 legal decisions are flat AND/OR chains (60/75 at the 2 − 2^−(n−1) closed form). Harness at `jl4/measure/`, re-runnable **[E]** | merged #264+#265; drafts #267→#268→#269                   |
