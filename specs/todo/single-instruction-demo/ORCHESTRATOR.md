...
| `p7-bpmn`      | DEGRADED            | —            | all three processes reproduce their goldens and pass soundness + interchange; the mandated BPMN→DMN wiring was not built at measurement time (since BUILT and MERGED — PR #198, 2026-08-03: vendor-neutral businessRuleTask + name-matching resolver; this row re-measures on the next G1 run) |
