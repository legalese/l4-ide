...
| **Executability**            | BPMN `isExecutable="false"`, 0 `businessRuleTask`, 0 `conditionExpression`, no DMN                                                                                        | 67 DMN decisions incl. 9 decision tables, 10 BKMs (3 more tables inside), 7 decisionServices, 15 inputData; **evaluates on two independent engines** over 20 cases — KIE 8.44.0.Final 1340/1340 decisions and values, Camunda 8.7.6 (zeebe-dmn) 1340/1340 (`PROJECTIONS.md` §1, CI-gated) |
