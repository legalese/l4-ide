...
**Both experiments are done and the gate is ruled: NO (§7.3, RULED 2026-09-21).** The heading's
"then maybe a picture" is now decided in the negative; the P2d and P2e rows below say NOT BUILT
and keep what they would have been, and §7.3 names the three things that would reopen them.
...
**RULED 2026-09-21 (Meng) — NO. P2d and P2e are not built.** The rule quoted below is the rule
that was applied, and it stays as written; what follows is the decision, the measurement it rests
on, and what would reopen it.
...
The first, the fourth and the fifth are also §7.3's three reopen conditions.
