...
| `D-MD-NODEFAULT`      | 286      | Lossy    | `Faithful`   | `OTHERWISE` becomes a final catch-all row and `U` demotes to `F`; the answers are preserved, _"the order-free reading"_ is not.                                                       |
