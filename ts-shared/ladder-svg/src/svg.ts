 ...
 * to S8's, and deliberately: DESIGN §26.1's fix gives the `dead` state its own ink, where
 * before it fell through to `inert` and a tested-and-false element drew exactly like a
