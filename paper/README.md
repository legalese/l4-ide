...
| **Replicating a Prolog benchmark**              | [`kant-replication/`](kant-replication/)                 | Empirical facet: L4 against the nine-query Chubb benchmark of Kant et al. 2025, with a dual-key scoring harness and a twenty-item defect register for their fixture. _The 2×3 measurement ran at n = 10 per cell on 2026-09-01 (all variance on the two interpretive items); a pre-registered repaired-benchmark arm on the restored fixture is in flight._ |
