...
| **Reached versus Material**                     | [`reached-vs-material/`](reached-vs-material/)           | The explanation facet: the materiality ladder (M1–M4), AXp/CXp engines over decision BDDs, frontier-crossing pivots, typed bitemporal counterfactuals. Spec-backed (`specs/todo/CALL-GRAPH-MATERIALITY-SPEC.md`). _Outline._ |
