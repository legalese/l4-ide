...
| **Replicating a Prolog benchmark**              | [`kant-replication/`](kant-replication/)                 | Empirical facet: L4 against the nine-query Chubb benchmark of Kant et al. 2025, with a dual-key scoring harness and a twenty-item defect register for their fixture. _Foundation phase complete; the 2×3 measurement is designed, not run._ |
