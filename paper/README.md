...
| **Replicating a Prolog benchmark**              | [`kant-replication/`](kant-replication/)                 | Empirical facet: L4 against the nine-query Chubb benchmark of Kant et al. 2025, with a dual-key scoring harness and a twenty-item defect register for their fixture. _Both arms ran at n = 10 per cell on 2026-09-01: as-published (450/450 mechanical, all variance on two interpretive items) and the pre-registered repaired-benchmark arm on the restored fixture (P1 supported: unguided Q5 5/20 → 14/20; adjudication in kant-replication/README.md §5.3)._ |
...
Submission windows for the facets above, plus outside venues where a contribution is _invited_ rather than submitted.
Checked 2026-09-21.
...
| **ProLaLa** (POPL workshop)  | Formal methods in law                          | POPL 2027                                        | —                                                                | **not checked.** The POPL _main_ track closed 9 Jul 2026; workshop rounds run separately and later | [POPL 2027](https://popl27.sigplan.org/dates)         |
