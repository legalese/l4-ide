...
\keywords{computational law, rules as code, controlled natural language,
...
requirement is not new. It is exactly the aspiration that gave us COBOL,
...
sub-paragraph numbering of the source, advancing isomorphism.
...
Backtick-delimited identifiers may contain spaces, so an identifier can be
the exact statutory phrase (\code{\bq is settled in the United Kingdom\bq}).
...
computational language for rules. From Grammatical Framework
