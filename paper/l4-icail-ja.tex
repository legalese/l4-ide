...
\noindent\textbf{キーワード：} 計算法学，rules as code，制御自然言語，関数型プログラミング，
...
読める規則である。この二重可読性の要請は新しいものではない。それはまさに，経営者が読めるものとして
...
バッククォートで囲った識別子は空白を含みうるので，識別子が法令の句そのもの
...
\paragraph{系譜}
L4の表層設計は，規則のための制御言語・計算言語の豊かな伝統を受け継いでいる。Grammatical Framework
