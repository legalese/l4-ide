...
*A public-facing essay: how an exam-cheating case became a proof — and what that
tells us about unifying law and computer science.*
...
*Poh Yuan Nie v PP* [2022] SGCA 74 — **enumerate** the four readings of "dishonest,"
**find** the forged-degree counterexample, **prove** Explanation 1 *otiose* — and
shows each is something a machine can do, while the fourth move (pronouncing the
outcome *absurd*) is the irreducibly judicial one.
...
| `cheating-415-espresso.py` | The minimiser that *deletes* the dead literal (Espresso, cross-checked against Quine–McCluskey). |
...
`sandbox`. Case text: *Poh Yuan Nie v Public Prosecutor* [2022] SGCA 74; statute:
