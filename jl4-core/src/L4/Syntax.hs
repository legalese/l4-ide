...
instance Semigroup Extension where
  Extension i1 nlg1 desc ref1 fix1 pm1 mx1 <> Extension i2 nlg2 desc' ref2 fix2 pm2 mx2 =
    Extension (i1 <|> i2) (nlg1 <|> nlg2) (desc <|> desc') (ref1 <|> ref2) (fix1 <|> fix2) (pm1 <|> pm2) (mx1 <|> mx2)
