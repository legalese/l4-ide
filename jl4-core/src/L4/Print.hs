...
-- what 'L4.Parser.deadline' wants. 'printWithLayout' — what the state graph's
-- @labelDeadline@ and the service's residual string call directly — leaves
-- the duration unbracketed, as @prettyLayout@ of the bare expression was.
