...
renderModule m =
  Text.unlines $
       [ "> Module " <> m.modName
       , ""
       , "Generated by `l4 catala` from " <> m.modSource <> "."
       , "Do not edit by hand; regenerate from the L4 source instead."
       ]
    <> warningLines m.modWarnings
    <> concatMap segmentLines m.modSegments

warningLines :: [Text] -> [Text]
warningLines [] = []
warningLines ws =
  "" : "Notes from the lowering:" : "" : [ "- " <> w | w <- ws ]
