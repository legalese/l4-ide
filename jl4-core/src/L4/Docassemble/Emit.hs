...
headerLines pkg =
  [ "# Generated by `l4 export docassemble` from " <> pkg.pkgSource <> "."
...
attachmentLines a =
     ...
     -- fails to load, in both artifact shapes, while `l4 export docassemble` exits 0.
...
pyprojectLines srcBase distName inner =
  [ "# Generated by `l4 export docassemble --package` from `" <> tomlComment srcBase <> "`."
  , "# Do not edit by hand; regenerate from the L4 source instead."
...
manifestLines inner fidelityName =
  [ "# Generated by `l4 export docassemble --package`; do not edit by hand."
...
runtimeLines srcBase distName slug =
  [ "\"\"\"Runtime module for " <> distName <> ", generated by `l4 export docassemble --package`."
  , ""
  ...
  , "L4_GENERATOR = 'l4 export docassemble --package'"
...
-- own line and @tomllib@ refused the file, while @l4 export docassemble --package@
