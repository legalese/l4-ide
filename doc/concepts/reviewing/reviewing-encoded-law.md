...
| [Blawx](https://www.blawx.com)                                      | visual, block-based rules-as-code over stable-model semantics (Jason Morris)                    | **a specified interchange target**: `specs/todo/BLAWX-EXPORT-SPEC.md` designs `l4 blawx` — decisions emitted as s(CASP) with justification trees and interviews, and a planned import direction back into L4 |
