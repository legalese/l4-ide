...
| ------ | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| DMN    | DMN 1.3 XML + fidelity report                                         | canonicalise-then-diff against the committed golden, the `dmn-moddle` interchange gate, and both engine harnesses over the committed `regcf-corpus.cases.json`                | `PASS`/`execution` since 2026-08-02 (PR #194 landed the cases file) — both engines agree, 1072/1072 values       |
