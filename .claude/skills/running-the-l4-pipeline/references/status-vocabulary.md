...
| ---------------- | ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| `execution`      | the artifact ran on its target engine, on committed cases, and agreed                                              | the two DMN engine harnesses; a `ready` MCP deployment enumerating one tool per compiled function          |
